    ...
    <div className="App">
      <div className={props.mode ? "midpart light-screen" : "midpart"}>
        <div
          className={
            props.mode
              ? "welcome-text-mobile light-top-component"
              : "welcome-text-mobile"
          }
        >
          <Link
          ...
          >
            <Button style={{ fontFamily: "Montserrat" }}>Home</Button>
          </Link>
        ...
        <div className="outer-holder">
          {PROJECTS.map((project) => (
            <Link to={"/projects/" + project.name}>
              <Card
                className={
                  props.mode ? "box_mobile-light box_mobile" : "box_mobile"
                }
                key={project.name}
              >
                {project.name === "hymn" ? (
